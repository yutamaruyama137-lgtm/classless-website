  ...
  return (
    <section ref={ref} style={{ paddingTop: 'clamp(72px, 9vw, 128px)', paddingBottom: 'clamp(36px, 4vw, 56px)' }}>
      <div className="cl-container">
        ...
        <h1 className="reveal" style={{ fontSize: 'clamp(40px, 6vw, 84px)', fontWeight: 900, marginTop: 18, letterSpacing: '0.02em', animationDelay: '0.06s' }}>経営理念</h1>
...
function Statement({ kind, tone, lines, copy, bg, glow }) {
  ...
  return (
    <section ref={ref} style={{ background: bg, position: 'relative', overflow: 'hidden', paddingTop: 'clamp(64px, 9vw, 144px)', paddingBottom: 'clamp(64px, 9vw, 144px)' }}>
      ...
      <div className="cl-container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <h2 className="reveal" style={{ fontSize: 'clamp(30px, 5vw, 68px)', fontWeight: 900, lineHeight: 1.34, letterSpacing: '0.01em', marginTop: 26, maxWidth: '20em', animationDelay: '0.08s' }}>{lines}</h2>
    ...
    <section ref={ref} style={{ background: 'var(--color-bg)', paddingTop: 'clamp(56px, 8vw, 112px)', paddingBottom: 'clamp(56px, 8vw, 112px)' }}>
      <div className="cl-container">
        <div className="reveal" style={{ textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 'clamp(26px, 3.6vw, 46px)', fontWeight: 900, marginTop: 18, lineHeight: 1.3 }}>大切にしている3つのこと</h2>
        </div>
  ...
  return (
    <React.Fragment>
      ...
      <Statement
        ...
        lines={<React.Fragment>AIで、人間を<span style={{ color: 'var(--brand-green)' }}>面白く</span>する。</React.Fragment>}
      ...
      <Statement
        ...
        lines={<React.Fragment>AIで、一人ひとりも、地方も、<br />社会も、もっと<span style={{ color: 'var(--brand-blue)' }}>ワクワク</span>していく未来。</React.Fragment>}
