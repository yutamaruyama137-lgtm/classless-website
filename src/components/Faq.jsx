...
function Faq() {
  ...
  const items = [
    ...
    {
      q: '導入までどのくらいかかりますか？',
      a: '開始までの期間は、対象業務の範囲、利用中のシステムとの連携、社内の確認工程によって変わります。初回診断とヒアリングの後に、作業内容とあわせて目安をご提示します。',
    },
    {
      q: 'どのようなツールに対応していますか？',
      a: 'Slack・Google Workspace・Microsoft 365、各種クラウド会計ソフト、CRM/SFAなど、100以上のサービス・ツールを対応・連携候補として整理しています。実際の接続可否と方法は、API仕様、契約プラン、権限、セキュリティ要件を確認したうえでご案内します。',
    },
    {
      q: '情報管理は大丈夫ですか？',
